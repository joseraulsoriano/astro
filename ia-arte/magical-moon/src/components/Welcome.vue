<template>
  <section class="welcome-container py-16 px-8 relative">
    ...
    >
      <img
        :src="mainCover"
        alt="Obra principal de la colección"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      <img
        :src="secondaryA"
        alt="Detalle complementario uno"
        class="secondary-image rounded-xl shadow-custom-light transform transition-all opacity-0 pointer-events-none"
        loading="lazy"
        decoding="async"
      />
      <img
        :src="secondaryB"
        alt="Detalle complementario dos"
        class="secondary-image rounded-xl shadow-custom-light transform transition-all opacity-0 pointer-events-none"
        loading="lazy"
        decoding="async"
      />
...
const mainCover = coverAt(0);
const secondaryA = coverAt(11);
const secondaryB = coverAt(24);
